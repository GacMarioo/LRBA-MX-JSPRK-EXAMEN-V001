...
```java
- C:\Users\w10\Documents\ejemplo\MPEH-MX-JSPRK-EJEMPLO-V00
| - local-execution
  | - database
...
- Folder **src** contains the java files:
  - **JobEjemploBuilder.java**: Indicates the sources and targets the generated application
