# MPEH-MX-JSPRK-EJE2CAPA2024-V00
...
```java
- C:\Users\w10\Documents\ejemplo\MPEH-MX-JSPRK-EJE2CAPA2024-V00
| - local-execution
  | - database
...
- Folder **src** contains the java files:
  - **JobEje2capa2024Builder.java**: Indicates the sources and targets the generated application
