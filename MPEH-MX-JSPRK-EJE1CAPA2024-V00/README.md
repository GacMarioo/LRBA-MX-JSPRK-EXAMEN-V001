# MPEH-MX-JSPRK-EJE1CAPA2024-V00
...
```java
- C:\Users\w10\Documents\ejemplo\MPEH-MX-JSPRK-EJE1CAPA2024-V00
| - local-execution
  | - database
...
- Folder **src** contains the java files:
  - **JobEje1capa2024Builder.java**: Indicates the sources and targets the generated application
